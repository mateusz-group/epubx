...
class NavigationReader {
  ...
  static EpubNavigationContent readNavigationContent(
    ...
    navigationContentNode.attributes.forEach((
      xml.XmlAttribute navigationContentNodeAttribute,
    ) {
  ...
  static EpubNavigationList readNavigationList(
    ...
    navigationListNode.attributes.forEach((
      xml.XmlAttribute navigationListNodeAttribute,
    ) {
  ...
  static EpubNavigationPageList readNavigationPageList(
    ...
    navigationPageListNode.children.whereType<xml.XmlElement>().forEach((
      xml.XmlElement pageTargetNode,
    ) {
  ...
  static EpubNavigationPageTarget readNavigationPageTarget(
    ...
    navigationPageTargetNode.attributes.forEach((
      xml.XmlAttribute navigationPageTargetNodeAttribute,
    ) {
    ...
    navigationPageTargetNode.children.whereType<xml.XmlElement>().forEach((
      ...
      switch (navigationPageTargetChildNode.name.local.toLowerCase()) {
        case 'navlabel':
          var navigationLabel = readNavigationLabel(
  ...
  static EpubNavigationPoint readNavigationPoint(
    ...
    navigationPointNode.attributes.forEach((
      xml.XmlAttribute navigationPointNodeAttribute,
    ) {
    ...
    navigationPointNode.children.whereType<xml.XmlElement>().forEach((
      ...
      switch (navigationPointChildNode.name.local.toLowerCase()) {
        ...
        case 'span':
          ...
          break;
        case 'ol':
          readNavigationMapV3(navigationPointChildNode).Points!.forEach((
            point,
          ) {
  ...
  static EpubNavigationTarget readNavigationTarget(
    ...
    navigationTargetNode.attributes.forEach((
      xml.XmlAttribute navigationPageTargetNodeAttribute,
    ) {
      var attributeValue = navigationPageTargetNodeAttribute.value;
      switch (navigationPageTargetNodeAttribute.name.local.toLowerCase()) {
